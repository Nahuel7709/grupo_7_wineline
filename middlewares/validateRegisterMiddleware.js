...
module.exports = [
    body("usersName").notEmpty().withMessage("Escriba su nombre y apellido").bail().isAlpha().withMessage("El nombre no debe contener numeros ni signos"),
    ...
    body("usersPassword").notEmpty().withMessage("Escriba su contraseña").bail().isLength({min:8, max:100}).withMessage("La contraseña debe tener un mínimo de 8 caracteres"),
    body("usersEmail").notEmpty().withMessage("Escriba su email").bail().isEmail().withMessage("Debes escribir un email válido"),
